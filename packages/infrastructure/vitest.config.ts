  ...
  defineConfig(
    createVitestConfig({
      ...
      coverageExclude: [
        ...
        'src/database/prisma-subtask-repository.ts',
        ...
        'src/database/prisma-nudge-log-repository.ts',
        ...
        'src/database/prisma-billing-customer-repository.ts',
        ...
        'src/usage/redis-proactive-send-guard.ts',
