...
export const pt: Messages = {
  ...
  billing: {
    ...
    sample: 'Amostra',
    freeFeatures: [
      'Listas do dia e ilimitadas, com compartilhamento',
      'Sequências de hábitos pra criar constância',
      'Um assistente que lembra de você',
      'IA que monta suas listas',
      'Uma amostra do assistente no WhatsApp',
    ],
    proFeatures: [
      'Tudo do Gratuito, com hábitos ilimitados',
      'Um "bom dia" com seu resumo todo dia',
      'Google Calendar sincronizado nos dois sentidos',
      'Lembretes por e-mail e WhatsApp',
      'O assistente completo no WhatsApp',
    ],
    premiumFeatures: [
      'Tudo do Pro',
      '"Achar horário" agenda seu foco por você',
      'Sugestões proativas que te mantêm na linha',
      'Agendas Apple e cal.com',
      'A IA mais forte e limites maiores',
    ],
