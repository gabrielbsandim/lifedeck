...
export const en: Messages = {
  ...
  habits: {
    manage: 'Habits',
    title: 'Habits',
    subtitle: 'Build streaks and let the assistant check in with you.',
    add: 'Add habit',
    empty: 'No habits yet.',
    ...
    edit: 'Edit',
    delete: 'Delete',
    upsellTitle: 'Track more habits',
    upsellBody:
      'Free includes one habit. Upgrade for unlimited habits and proactive check-ins.',
    upsellCta: 'Upgrade',
  },
  nav: {
    today: 'Today',
  ...
  billing: {
    ...
    sample: 'Sample',
    freeFeatures: [
      'Daily & unlimited lists, shared by link',
      'Habit streaks to build momentum',
      'An assistant that remembers you',
      'AI that builds your lists',
      'A taste of the WhatsApp assistant',
    ],
    proFeatures: [
      'Everything in Free, unlimited habits',
      'A "good morning" brief every day',
      'Google Calendar, two-way synced',
      'Reminders by email & WhatsApp',
      'The full WhatsApp assistant',
    ],
    premiumFeatures: [
      'Everything in Pro',
      '"Find me time" books your focus blocks',
      'Proactive nudges keep you on track',
      'Apple & cal.com calendars',
      'The strongest AI, highest limits',
    ],
