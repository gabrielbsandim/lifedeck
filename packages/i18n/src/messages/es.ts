...
export const es: Messages = {
  ...
  billing: {
    ...
    tagline: 'Empieza gratis. Mejora cuando Lifedeck sea parte de tu día.',
    plansTitle: 'Planes',
    ...
    subscribePlan: 'Suscribirse a {plan}',
    compare: 'Compara los planes',
    sample: 'Muestra',
    freeFeatures: [
      'Lista del día y listas ilimitadas',
    ...
    premiumFeatures: [
      'Todo lo de Pro',
      'Modelo de IA más potente',
      'Límites mayores de generación',
    ],
    ...
    close: 'Cerrar',
    footerCancel: 'Cancela cuando quieras, desde la app.',
